...
public class FileSystemHandlerConcurrentTest
{

	@Rule
	public TestName name = new TestName();

	FileSystemHandlerConcurrent fsh = null;

	public FileSystemHandlerConcurrentTest()
	{
		fsh = new FileSystemHandlerConcurrent();
	}
